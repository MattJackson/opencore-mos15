...
for p in /Users/mjackson/opencore-mos15/upstream-pr/patches/*.patch; do
    git am < "$p"
done
...
gh pr create \
    ...
    --body-file /Users/mjackson/opencore-mos15/upstream-pr/PR_DESCRIPTION.md
```
...
ls /Users/mjackson/opencore-mos15/upstream-pr/patches/*.patch
```
